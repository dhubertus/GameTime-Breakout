...
var start = null;
Board.prototype.restartBall = function (timer, context) {
  // this.ball.x += this.ball.vx
  // this.ball.y += this.ball.vy
  //if ball hits bottom, wait ~3secnds restart the ball
  ...
  if (this.ball.vx === 0 && this.ball.vy === 0 && delay > 3000) {
...
Board.prototype.ballPause = function(timer) {
  //
